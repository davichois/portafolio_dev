      ...
      <ProjectPageEnter>
        ...
        >
          <div className="absolute inset-0">
            ...
            />
            <div
              className="absolute inset-0 bg-linear-to-b from-black/100 via-black/95 to-black/90 sm:from-black/90 sm:via-black/80 sm:to-black/90"
              aria-hidden
            />
          </div>
          ...
          <div className="mx-auto max-w-[1920px] px-5 py-14 sm:px-8 sm:py-16 md:px-12 md:py-20 lg:px-16 lg:py-24 xl:px-24">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16 xl:gap-20">
              ...
              <div className="lg:col-span-5 xl:col-span-4">
                ...
                <dl className="mt-10 sm:mt-12">
                  ...
                  <MetaRow
                    label="Status"
                    value={
                      project.featured ? "Featured project" : "Portfolio build"
                    }
                  />
                </dl>
              ...
              <div className="min-w-0 lg:col-span-7 xl:col-span-8">
                ...
                <div
                  className="mt-6 h-px w-full bg-border sm:mt-8"
                  aria-hidden
                />
