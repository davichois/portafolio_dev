...
export default function ProjectsPage() {
  ...
  useEffect(() => {
    ...
    return () => {
      logProjectsScroll(
        "/projects scroll lock cleanup (releaseDocumentScroll)",
        {
          wasNavigating: true,
        },
      );
  ...
  return (
    <main className="min-h-screen w-full overflow-x-hidden border-t border-border bg-background text-foreground">
      ...
      >
        <header className="mb-10 max-w-4xl md:mb-14 lg:mb-16">
          ...
          <p className="mt-5 text-sm leading-relaxed text-foreground/55 sm:text-base md:text-lg">
            Más que solo proyectos, son retos que me ayudaron a crecer en esta
            industria y a descubrir nuevos mercados. Abre cualquier tarjeta para
            explorar el caso de estudio completo.
          </p>
        </header>
