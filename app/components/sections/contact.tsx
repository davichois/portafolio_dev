...
export default function Contact() {
  ...
  const socialLinks = [
    { name: "GitHub", icon: Github, url: "https://github.com/davichois" },
    {
      name: "LinkedIn",
      icon: Linkedin,
      url: "https://www.linkedin.com/in/david-prada-linarez-ba8795192/",
    },
  ];

  const copyEmail = (e: React.MouseEvent) => {
    e.preventDefault();
    navigator.clipboard.writeText("davidscite34@gmail.com");
    setCopied(true);
  ...
  return (
    <section
      ref={containerRef}
      id="contact"
      className="contact-section relative w-full py-32 bg-background overflow-hidden"
    >
      {/* Background Atmosphere */}
      <div className="absolute top-0 right-0 w-130 h-130 bg-foreground/4 blur-[110px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-105 h-105 bg-foreground/3 blur-[100px] rounded-full pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="space-y-12">
            <div className="space-y-2 overflow-hidden">
              ...
              <div className="overflow-hidden">
                <h2 className="contact-header-text block text-[clamp(3rem,7vw,4rem)] font-black uppercase leading-[0.9] text-foreground">
                  Trabajemos
                </h2>
              </div>
            ...
            <div className="space-y-8 max-w-md">
              <p className="contact-content text-lg text-foreground/65 leading-relaxed font-light">
                ...
                Siempre estoy abierto a hablar sobre nuevas oportunidades y
                desafíos
              </p>
          ...
          <div className="w-full h-full flex flex-col justify-center lg:pt-12">
            <a
              ref={emailRef}
              href="mailto:davidscite34@gmail.com"
            ...
            >
              <div className="relative h-full flex flex-col justify-between z-10 px-2 sm:px-0">
                ...
                <div>
                  <span className="text-xs uppercase tracking-[0.2em] text-foreground/45 mb-4 block">
                    Drop me a line
                  </span>
                  ...
                  >
                    {copied ? (
                      ...
                      <>
                        ...
                        <span className="group-hover/btn:underline decoration-foreground/30 underline-offset-4">
                          Copiar Email
                        </span>
                      </>
                    )}
