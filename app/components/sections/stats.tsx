...
export default function Stats() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const panels: HTMLElement[] = [leftPanel, rightPanel].filter(
        ...
        <div className="flex min-w-0 flex-col lg:flex-row lg:justify-between lg:items-start gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20 2xl:gap-24">
          ...
          <div className="stats-panel-left w-full min-w-0 max-w-full lg:w-[42%] lg:max-w-none xl:w-5/12 space-y-4 sm:space-y-5 md:space-y-6">
            ...
            <p className="stats-anim max-w-full text-[0.9375rem] leading-relaxed text-foreground/70 wrap-anywhere sm:max-w-lg sm:text-base md:text-lg">
              Ingeniero de Sistemas y Desarrollador Full Stack, apasionado por
              transformar ideas en aplicaciones web modernas, escalables y de
              alto rendimiento.
            </p>
            ...
            <p className="stats-anim max-w-full text-[0.8125rem] leading-relaxed text-foreground/55 wrap-anywhere sm:max-w-lg sm:text-sm md:text-base">
              Lideré el desarrollo móvil de un sistema de monitoreo de
              asistencia en tiempo real y la implementación de soluciones IoT
              para Hábitat Ecoambiental. Además, formé parte del equipo ganador
              de la primera hackatón de la región San Martín. También he
              desarrollado plataformas empresariales y de distribución con
              paneles analíticos, reportes inteligentes y sistemas avanzados de
              roles y permisos.
            </p>

            <p className="stats-anim max-w-full text-[0.8125rem] leading-relaxed text-foreground/55 wrap-anywhere sm:max-w-lg sm:text-sm md:text-base">
              Me apasiona escribir código limpio, resolver desafíos complejos y
              construir productos digitales que generen impacto real, combinando
              innovación, eficiencia y una experiencia centrada en las personas.
            </p>
          </div>
