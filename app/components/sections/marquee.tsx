    ...
    const ctx = gsap.context(() => {
      ...
      mm.add("(min-width: 768px)", () => {
        ...
        const calculateValues = (trackEl: HTMLDivElement) => {
          ...
          const offscreenLeft = -Math.min(
            maxTravel + viewport * 0.2,
            maxTravel + 900,
          );
        ...
        <div className="w-full flex flex-col justify-center gap-12 lg:gap-14">
          ...
          >
            ...
            <div className="ml-24 pr-32 flex flex-col gap-2">
              ...
              <span className="text-xl text-foreground/70 font-bold uppercase tracking-tight">
                Android Development
              </span>
              <span className="text-xl text-foreground/70 font-bold uppercase tracking-tight">
      ...
      <div className="md:hidden px-6 flex flex-col gap-12">
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-3xl font-light italic text-foreground/30">
              &
            </span>
            <div className="h-px flex-1 bg-border" />
          </div>
          <div
            ref={mobileRow2Ref}
            className="whitespace-nowrap -translate-x-12 flex justify-end"
          >
            <span className="text-7xl font-black text-foreground uppercase leading-none tracking-tighter">
              App Dev
            </span>
        ...
        <div className="mobile-services-grid grid grid-cols-1 gap-4 pt-8">
          ...
          {[
            ...
            <div
              key={i}
              className="mobile-service-item flex items-center gap-3"
            >
