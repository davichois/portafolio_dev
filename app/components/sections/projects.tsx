...
export default function Projects() {
  ...
  useEffect(() => {
    ...
    return () => {
      logProjectsScroll(
        "home #projects scroll lock cleanup (releaseDocumentScroll)",
        {
          wasNavigating: true,
        },
      );
                ...
                {featured.map((project, index) => {
                  ...
                  return (
                    <button
                      ...
                      className="group flex items-center gap-3 rounded-full text-left outline-none ring-foreground/30 focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-60"
                    >
                      <motion.div
                        ...
                        className="relative h-14 w-14 shrink-0 origin-left overflow-hidden rounded-full border border-border bg-transparent sm:h-20 sm:w-20"
                        aria-hidden
                      >
                        <Image
                          src={project.image}
